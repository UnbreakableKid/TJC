...
public class WeightedVotedGame {
    public double[] v;
    public int nPlayers;
    public String[] ids;
    ...
    public WeightedVotedGame(double[] v) {
        this.v = v;
        this.nPlayers = (int) (Math.log(v.length) / Math.log(2));
        setPlayersID();
    }

    public WeightedVotedGame(String filename) throws FileNotFoundException {
        ...
        while (currentLine < nLines-2) {

            String lineRead = valuesFileReader.nextLine();

            players[currentLine] = Double.parseDouble(lineRead);
        ...
        this.threshold = Integer.parseInt(lineRead);

        lineRead = valuesFileReader.nextLine();

        this.reward = Double.parseDouble(lineRead);
...
//    }
    ...
    public void doShapleyForEveryone() {
        ...
        for (int i = 0; i < shapleys.length ; i++) {
            ...
            System.out.println(ids[ids.length - i-1] + " : " + shapleys[i]);
...
//        String filename = "Prob2a.txt";
//        String filename = "Prob2b.txt";
//        String filename = "C4.txt";
//        String filename = "C5.txt";
        String filename = "C6.txt";

        WeightedVotedGame c = new WeightedVotedGame(filename);
        //c.showGame();
